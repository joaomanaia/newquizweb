    ...
    <div>
      ...
      <Container>
        ...
        <p>
          ...
          information in certain areas of the website. InfinitePower does not filter, edit, publish
          or review Comments prior to their presence on the website. Comments do not reflect the
          views and opinions of InfinitePower,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, InfinitePower shall not be liable for the Comments or for
        ...
        <p>
          You hereby grant InfinitePower a non-exclusive license to use, reproduce, edit and
        ...
        <p>
          ...
          visibility of the hyperlink compensates the absence of InfinitePower; and (d) the link is
        ...
        <p>
          No use of InfinitePower logo or other artwork will be allowed for linking absent a
...
export default AndroidTermsPage
