  ...
  return (
    <div>
      <Head>
        ...
        <NextSeo title="Privacy" description="NewQuiz privacy" />
      </Head>
      ...
      <RootLayout>
        <Container>
          ...
          <p>
            ...
            continue to use NewQuiz if you do not agree to take all of the terms and conditions
            stated on this page.
          </p>
          ...
          <p>
            We employ the use of cookies. By accessing NewQuiz, you agreed to use cookies in
            agreement with the InfinitePower Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, InfinitePower and/or its licensors own the intellectual
            property rights for all material on NewQuiz. All intellectual property rights are
            reserved. You may access this from NewQuiz for your own personal use subjected to
          ...
          <p>
            ...
            information in certain areas of the website. InfinitePower does not filter, edit,
            publish or review Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of InfinitePower,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views and opinions. To the
            extent permitted by applicable laws, InfinitePower shall not be liable for the Comments
          ...
          <p>
            InfinitePower reserves the right to monitor all Comments and to remove any Comments
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of InfinitePower; and (d) the link
