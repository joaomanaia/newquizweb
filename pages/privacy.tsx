  ...
  return (
    <div>
      ...
      <Container>
        ...
        <p>
          At NewQuiz, accessible from https://newquiz.vercel.app, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types of information that
          is collected and recorded by NewQuiz and how we use it.
        </p>
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in NewQuiz. This
        ...
        <p>
          Like any other website, NewQuiz uses &apos;cookies&apos;. These cookies are used to store
        ...
        <p>
          ...
          Beacons that are used in their respective advertisements and links that appear on NewQuiz,
