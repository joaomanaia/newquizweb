...
const AndroidTermsPage: React.FC = () => {
  return (
    <div>
      ...
      <RootLayout>
        <Container>
          <h1>Privacy Policy for InfinitePower</h1>

          <p>
            At NewQuiz, accessible from https://newquiz.vercel.app, one of our main priorities is
            the privacy of our visitors. This Privacy Policy document contains types of information
            that is collected and recorded by NewQuiz and how we use it.
          </p>
          ...
          <p>
            ...
            our website with regards to the information that they shared and/or collect in NewQuiz.
          ...
          <p>
            NewQuiz follows a standard procedure of using log files. These files log visitors when
          ...
          <p>
            Like any other website, NewQuiz uses &apos;cookies&apos;. These cookies are used to
          ...
          <p>
            ...
            NewQuiz, which are sent directly to users&apos; browser. They automatically receive your
          ...
          <p>
            Note that NewQuiz has no access to or control over these cookies that are used by
          ...
          <p>
            NewQuiz&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we
          ...
          <p>
            NewQuiz does not knowingly collect any Personal Identifiable Information from children
