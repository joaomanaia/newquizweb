  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        scrim: "hsl(var(--scrim))",
        easy: {
          DEFAULT: "rgb(var(--extended-color-easy-color))",
          foreground: "rgb(var(--extended-color-easy-on-color))",
        },
        easyContainer: {
          DEFAULT: "rgb(var(--extended-color-easy-color-container))",
          foreground: "rgb(var(--extended-color-easy-on-color-container))",
        },
        medium: {
          DEFAULT: "rgb(var(--extended-color-medium-color))",
          foreground: "rgb(var(--extended-color-medium-on-color))",
        },
        mediumContainer: {
          DEFAULT: "rgb(var(--extended-color-medium-color-container))",
          foreground: "rgb(var(--extended-color-medium-on-color-container))",
        },
        hard: {
          DEFAULT: "rgb(var(--extended-color-hard-color))",
          foreground: "rgb(var(--extended-color-hard-on-color))",
        },
        hardContainer: {
          DEFAULT: "rgb(var(--extended-color-hard-color-container))",
          foreground: "rgb(var(--extended-color-hard-on-color-container))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
