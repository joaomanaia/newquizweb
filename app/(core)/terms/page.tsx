...
export default function Page() {
  return (
    <MainContainer>
      ...
      <p>Welcome to NewQuiz!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of
        InfinitePower&apos;s Website, located at https://newquiz.vercel.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use NewQuiz if you do not agree to take all of the terms and conditions stated on this
        page.
      </p>
      ...
      <p>
        ...
        stated services, in accordance with and subject to, prevailing law of Netherlands. Any use
        of the above terminology or other words in the singular, plural, capitalization and/or
      ...
      <p>
        We employ the use of cookies. By accessing NewQuiz, you agreed to use cookies in agreement
        with the InfinitePower Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, InfinitePower and/or its licensors own the intellectual property
        rights for all material on NewQuiz. All intellectual property rights are reserved. You may
        access this from NewQuiz for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from NewQuiz</li>
        <li>Sell, rent or sub-license material from NewQuiz</li>
        <li>Reproduce, duplicate or copy material from NewQuiz</li>
        <li>Redistribute content from NewQuiz</li>
      </ul>

      <p>This Agreement shall begin on the date of 08/27/2022</p>

      <p>
        Parts of this website offer an opportunity for users to post and exchange opinions and
        information in certain areas of the website. InfinitePower does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not reflect the views
        and opinions of InfinitePower,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, InfinitePower shall not be liable for the Comments or for any liability,
        damages or expenses caused and/or suffered as a result of any use of and/or posting of
        and/or appearance of the Comments on this website.
      </p>

      <p>
        InfinitePower reserves the right to monitor all Comments and to remove any Comments which
      ...
      <p>
        You hereby grant InfinitePower a non-exclusive license to use, reproduce, edit and authorize
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of InfinitePower; and (d) the link is in
      ...
      <p>
        ...
        linking to our website, you must inform us by sending an e-mail to InfinitePower. Please
      ...
      <p>
        No use of InfinitePower logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
