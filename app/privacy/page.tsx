  ...
  return (
    <>
      ...
      <p>
        ...
        collected and recorded by NewQuiz and how we use it.
      </p>
      ...
      <p>
        NewQuiz follows a standard procedure of using log files. These files log visitors when they
      ...
      <p>
        NewQuiz&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are
      ...
      <p>
        NewQuiz does not knowingly collect any Personal Identifiable Information from children under
